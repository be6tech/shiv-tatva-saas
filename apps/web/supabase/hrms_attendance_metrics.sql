...
alter table public.hrms_attendance
  ...
  add column if not exists check_in_at_local text,
  add column if not exists check_out_at_local text,
  add column if not exists lunch_in_at_local text,
  add column if not exists lunch_out_at_local text,
  add column if not exists break_in_at_local text,
  add column if not exists break_out_at_local text,
